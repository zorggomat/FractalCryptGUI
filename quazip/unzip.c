...
/*
  Locate the Central directory of a zipfile (at the end, just before
    the global comment)
*/
local ZPOS64_T unz64local_SearchCentralDir OF((const zlib_filefunc64_32_def* pzlib_filefunc_def, voidpf filestream, unsigned long long eocdPos, int posDefined));
local ZPOS64_T unz64local_SearchCentralDir(const zlib_filefunc64_32_def* pzlib_filefunc_def, voidpf filestream, unsigned long long eocdPos, int posDefined)
{
    unsigned char* buf;
    ZPOS64_T uSizeFile;
    ZPOS64_T uBackRead;
    ...
    if(posDefined)
        uSizeFile = eocdPos;
    else uSizeFile = ZTELL64(*pzlib_filefunc_def,filestream);
...
local ZPOS64_T unz64local_SearchCentralDir64 OF((
    const zlib_filefunc64_32_def* pzlib_filefunc_def,
    voidpf filestream, unsigned long long eocdPos, int posDefined));
...
extern unzFile unzOpenInternal (voidpf file,
                               ...
                               int is64bitOpenFunction, unsigned flags, unsigned long long eocdPos, int posDefined)
{
    unz64_s us;
    unz64_s *s;
    ...
    central_pos = unz64local_SearchCentralDir64(&us.z_filefunc,us.filestream,eocdPos,posDefined);
    if (central_pos)
    {
        uLong uS;
        ZPOS64_T uL64;
    ...
    {
        central_pos = unz64local_SearchCentralDir(&us.z_filefunc,us.filestream,eocdPos,posDefined);
        if (central_pos==0)
            err=UNZ_ERRNO;
                                        ...
                                        zlib_filefunc_def* pzlib_filefunc32_def)
{
    if (pzlib_filefunc32_def != NULL)
    {
        ...
        return unzOpenInternal(file, &zlib_filefunc64_32_def_fill, 0, UNZ_DEFAULT_FLAGS, 0, 0);
    }
    else
        return unzOpenInternal(file, NULL, 0, UNZ_DEFAULT_FLAGS, 0, 0);
}
                                     ...
                                     zlib_filefunc64_def* pzlib_filefunc_def)
{
    if (pzlib_filefunc_def != NULL)
    {
        ...
        return unzOpenInternal(file, &zlib_filefunc64_32_def_fill, 1, UNZ_DEFAULT_FLAGS, 0, 0);
    }
    else
        return unzOpenInternal(file, NULL, 1, UNZ_DEFAULT_FLAGS, 0, 0);
}
